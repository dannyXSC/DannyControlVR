...
public class NetworkManager : MonoBehaviour
{
    ...
    {
        return "tcp://" + netConfig.IPAddress + ":" + netConfig.switchNum;
    }
    
    public string GetStageAddress()
    {
        return "tcp://" + netConfig.IPAddress + ":" + netConfig.stagePortNum;
    }
    ...
    void Start()
    {
        ...
        // for test
        // ChangeIPAddress("10.177.63.108");
        ChangeIPAddress("10.177.63.71");
        // ChangeIPAddress("10.162.189.83");
    }
